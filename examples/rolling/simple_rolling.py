...
# How much to scale things up and down
up = 1.75
down = 0.25
...
for filtername, filtername2 in zip(filter1s, filter2s):
    ...
    target_list = [even_year_target[filtername], odd_year_target[filtername], even_year_target[filtername]]
...
observatory, scheduler, observations = fs.sim_runner(observatory, scheduler,
                                                     ...
                                                     filename='simple_rolling_%iyrs.db' % years,
